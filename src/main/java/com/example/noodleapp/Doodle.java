...
public class Doodle extends Scrapper{

    private WebDriver driver;
    private Actions actions;
    private ArrayList<DoodlePoll> reunions;
    private ArrayList<DoodlePoll> reunionsGarde = new ArrayList<>();
    ...
    public void mainDoodle(String login, String password) throws ParseException, InterruptedException {
        ...
        for (DoodlePoll r : reunionsGarde) {
    ...
    public void getAllTheInfomationPerLink(String href) throws InterruptedException {
        ...
        try {
            ...
            try {
                ...
                int titlebreDeReu = driver.findElements(By.cssSelector(".OptionHeader.OptionHeader__option-default")).size();
                if (titlebreDeReu == 1) {
                    DoodlePoll reunion = new DoodlePoll();
                ...
                } else if(titlebreDeReu != 0 && titlebreDeReu != 1) {
                    try {
                        ...
                        DoodlePoll DoodlePoll = new DoodlePoll();
                        ...
                        for (WebElement e : filteredElements) {
                            getDetailsOrga(DoodlePoll, e);
                        }
                        /*for (PropsDoodle p : DoodlePoll.getPropsDoodleList()) {
                            System.out.println("title : " + DoodlePoll.gettitle() + "\nDate : " + p.getDate() + "\nHeure debut :" + p.getHeureDebut() + "\nHeure Fin : " + p.getHeureFin() + "\ntitlebre de votes :" + p.getNbrDeVotant() + "\nMa réponse :" + p.getReponse());
                        }
                         */
                        DoodlePoll.setOrganisateur("MOI");
                        reunions.add(DoodlePoll);
                    }catch (Exception ee){
            ...
            try {
                ...
                if(isDateAfterCurrentDate()){
                    DoodlePoll DoodlePoll = new DoodlePoll();
                    getInformationPollBookedOrga(DoodlePoll);
                    DoodlePoll.setOrganisateur("MOI");
                    DoodlePoll.getPropsDoodleList().get(0).setReponse(Reponse.ORGANISATEUR);
                    reunions.add(DoodlePoll);
                }
        ...
        try {
            ...
            if(text.equals("You’re booked!")) {
                ...
                int titlebreDeReu = driver.findElements(By.cssSelector(".votes-option-module_day__GfSdw")).size(); //le cas où je n'ai qu'une seul reunion
                if (titlebreDeReu == 1) {
                    DoodlePoll reunion = new DoodlePoll();
                    ...
                    //System.out.println("titlebre de prop: "+touteLesReunion.size());
                    DoodlePoll r = new DoodlePoll();
                    ...
                    //System.out.println("titlebre de prop still present: "+filteredElements.size());
    ...
    public void getDetailsInvite(DoodlePoll reunion, WebElement webElement){
        ...
        try {
            ...
            reunion.settitle(titleElement.getText());
        } catch (Exception e) {
        ...
        try{
            ...
            try{
                ...
                System.out.println("je n'arrive pas à avoir le titlebre de votant");
            }
        }
    ...
    public void getDetailsInviteDriver(DoodlePoll reunion){
        PropsDoodle propsDoodle = new PropsDoodle();
        //getLaDate
        try {
...
// get la localisation
    ...
    public void getDetailsOrga(DoodlePoll DoodlePoll, WebElement webElement){
        PropsDoodle propsDoodle = new PropsDoodle();
        try {
            //getTheDuration
            Thread.sleep(500);
            List<WebElement> conteneur = driver.findElements(By.cssSelector(".MetadataItem__content"));
            DoodlePoll.setDuree(conteneur.get(0).getText());
            //DoodlePoll.setLocalisation(conteneur.get(1).getText());
        } catch (Exception e) {
        ...
        try{
            ...
            if (button.getText().equals("Show meeting details")) {
                ...
                DoodlePoll.setLocalisation(location.getText());
            }
        }catch (Exception e){
        ...
        try {
            ...
            DoodlePoll.settitle(title.getText());
        } catch (Exception e) {
            System.out.println("je n'arrive pas a avoir la titre");
        }

        //get titlebre de vote
        try {
        ...
        try{
            ...
            //DoodlePoll.setFuseauHoraire(element.getText());
        ...
        DoodlePoll.getPropsDoodleList().add(propsDoodle);
    }



    public void getDetailsOrgaDriver(DoodlePoll DoodlePoll){
        try {
            //showMore
    ...
    public void getInformationPollBooked(DoodlePoll DoodlePoll){
        PropsDoodle propsDoodle = new PropsDoodle();
        try {
        ...
        try {
            ...
            DoodlePoll.setOrganisateur(organizerName);
        }catch (Exception e){
        ...
        try {
            ...
            DoodlePoll.settitle(meetingTitle);
        }catch (Exception e){
        ...
        try {
            ...
            WebElement l = loc.findElement(By.cssSelector("p"));
            if (l.getText().equals("Switzerland - Zürich, Genève, Basel, Lausanne")) {
                DoodlePoll.setLocalisation("Localisation non précisé");
            } else {
                DoodlePoll.setLocalisation(l.getText());
            }
    ...
    public void getInformationPollBookedOrga(DoodlePoll DoodlePoll) {
        PropsDoodle propsDoodle = new PropsDoodle();
        DoodlePoll.getPropsDoodleList().add(propsDoodle);
        //get Titre
        try {
        ...
        try {
            ...
            DoodlePoll.getPropsDoodleList().get(0).setDate(formatDate(date));
        }catch (Exception e){
        ...
        try {// Rechercher l'élément contenant les informations de temps
            ...
            DoodlePoll.getPropsDoodleList().get(0).setHeureDebut(isTheHourConforme(start));
            DoodlePoll.getPropsDoodleList().get(0).setHeureFin(isTheHourConforme(end));
        }catch (Exception e){
        ...
        try{
            ...
            DoodlePoll.getPropsDoodleList().get(0).setTimeZone(timeZoneText.getText());
        }catch (Exception e){
            System.out.println("Je n'arrive pas à avoir le timezone");
        }
    ...
    public List<DoodlePoll> getReunions(){
        return reunions;
    }
    public List<DoodlePoll> getReunionsGarde(){
        return reunionsGarde;
    }

    public void isThePollStillPresent(DoodlePoll DoodlePoll) throws InterruptedException {
        try {
            WebElement changeResponseButton = driver.findElement(By.cssSelector(".OptionHeader__option-past"));
            DoodlePoll.setToujourValable(false);
        }catch (Exception e) {
            try{
                WebElement elemntPast = driver.findElement(By.cssSelector(".votes-option-module_votes-option--past__TQ0XP"));
                DoodlePoll.setToujourValable(false);
            }catch (Exception ee){
                DoodlePoll.setToujourValable(true);
            }
    ...
    public void validerReunion(DoodlePoll reunion) throws InterruptedException {
    ...
    public void setTimeZoneForAllPoll(ArrayList<DoodlePoll> DoodlePolls){
        String gmt = "";
        for(DoodlePoll DoodlePoll : DoodlePolls){
            for(PropsDoodle p : DoodlePoll.getPropsDoodleList()){
                String regex = "GMT[+-]\\d+";
    ...
    public void seConformiser(ArrayList<DoodlePoll> DoodlePolls) throws ParseException {
        for(DoodlePoll DoodlePoll : DoodlePolls){
            for(PropsDoodle p : DoodlePoll.getPropsDoodleList()) {
                ...
                props.date = p.getDateConforme();
                props.hour = p.getHourDebutConforme();
                props.eachAnswer = p.getEachAnswer();
               //props.timeZone = (net.fortuna.ical4j.model.TimeZone) p.getTimeZoneConforme();
                DoodlePoll.getProps().add(props);
            }
        }
    }

    public void garderLesCreneauDeReunionSouhaite(ArrayList<DoodlePoll> DoodlePolls){
        for (DoodlePoll reunion : DoodlePolls) {
            if (reunion.getPropsDoodleList().size() > 1) {
                ...
                // Détermine le titlebre maximum de votants.
                int maxVotes = 0;
                for (PropsDoodle props : propsList) {
                ...
                // Ajoute toutes les propositions qui ont le titlebre maximum de votants.
    ...
    public void createICS(WebClient wb, String path){
        try {
            // Define timezone
            ...
            for(DoodlePoll DoodlePoll : getReunionsGarde()) {
                int i = 0;
                //avoir le format d'une adresse mail
                for (PropsDoodle p : DoodlePoll.getPropsDoodleList()) {
                    try {
                        if (DoodlePoll.getPropsDoodleList().get(0).getReponse().equals(Reponse.ORGANISATEUR)) {
                            VEvent event = createEvent("moi@noodle.com", DoodlePoll.gettitle()+i + " Vous ếtes l'organisateur ", DoodlePoll.getLocalisation(), p.getDate(), p.getHeureDebut(), p.getHeureFin(), timezone);
                            calendar.getComponents().add(event);
                        } else {
                            String[] adressMailspliter = DoodlePoll.getOrganisateur().split(" ");
                            String mailAdresse = adressMailspliter[0] + adressMailspliter[1] + "@noodle.com";
                            VEvent event = createEvent(mailAdresse, DoodlePoll.gettitle()+i + " Vous avez dit : " + p.getReponse(), DoodlePoll.getLocalisation(), p.getDate(), p.getHeureDebut(), p.getHeureFin(), timezone);
                            calendar.getComponents().add(event);
                        }
                    } catch (Exception e) {
    ...
    private static VEvent createEvent(String organizer, String summary, String location, String date, String startTime,
                                      String endTime, net.fortuna.ical4j.model.TimeZone timezone) throws ValidationException, URISyntaxException {
        // Define the event
